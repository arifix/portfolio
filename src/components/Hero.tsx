...
const Hero = () => {
  return (
    <section
      id="hero"
      className="hero pt-20 md:pt-32 pb-20 md:pb-44 bg-slate-50 bg-opacity-50 dark:bg-gradient-to-r dark:from-slate-700 dark:via-slate-900 dark:to-slate-950"
    >
        ...
        <div className="w-full md:w-3/5 mt-8 space-y-2">
          ...
          <div className="flex gap-3 my-10">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex gap-2 items-center px-4 py-2 leading-6 rounded-sm text-[16px] text-white border bg-gray-500 hover:bg-white hover:text-gray-900 dark:hover:bg-slate-900"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex gap-2 items-center px-4 py-2 leading-6 rounded-sm text-[16px] text-gray-900 border bg-white hover:bg-gray-500 hover:text-white dark:bg-slate-600 dark:hover:bg-slate-900"
            >
              Schedule a Meeting
            </a>
          </div>
